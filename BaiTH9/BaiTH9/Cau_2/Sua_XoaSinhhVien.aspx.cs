...
{
    public partial class Sua_XoaSinhhVien : System.Web.UI.Page
    {
        private string strCon = "Data Source=SKY-20200706ULN;Initial Catalog=QuanlyhocDB;Integrated Security=True";
        private QuanLyHoc_DBDataContext myQLHDBDataContext;
        ...
        {
            myQLHDBDataContext = new QuanLyHoc_DBDataContext(strCon);
            if (!IsPostBack)
            {
