<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sua_XoaSinhhVien.aspx.cs" Inherits="BaiTH9.Cau_2.Sua_XoaSinhhVien" %>
            ...
            <table style="width:100%;">
                ...
                <tr>
                    ...
                    <td class="auto-style3">
                        <asp:Button ID="btnThem" runat="server" OnClick="btnThem_Click" Text="Thêm" Width="79px" />
                        <asp:Button ID="btnGhi" runat="server" OnClick="btnGhi_Click" Text="Ghi lại" Width="79px" />
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
